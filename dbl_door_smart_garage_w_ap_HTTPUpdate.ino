...
{ "title": "Hey, man!", "uri": "/", "menu": true, "element": [
    { "name": "caption", "type": "ACText", "value": "<h2>Hey, man!</h2>",  "style": "text-align:center;color:#2f4f4f;padding:10px;" },
    { "name": "content", "type": "ACText", "value": "In this page, shit happens." } ]
}
)";
...
httpUpdate.setup(&httpServer, USERNAME, USERPASS); // Step #9.a
